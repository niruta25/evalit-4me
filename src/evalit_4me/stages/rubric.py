...
def init_template(target: Path | str, *, overwrite: bool = False) -> Path:
    ...
    # `__file__` is src/evalit_4me/stages/rubric.py
    # parents[3] is the repo root (src/evalit_4me/stages -> src/evalit_4me -> src -> repo).
    template = Path(__file__).resolve().parents[3] / "configs" / "template.yaml"
